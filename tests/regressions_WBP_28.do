...
esttab est1 est1a est1b est1c, se scalars(N r2 bic) mtitles keep(Kphy Korg Kknow Emp Assets Sales MSA_Unemp)
esttab est1 est1d est1e est1f, se scalars(N r2 bic) mtitles keep(Kphy Korg Kknow Emp Assets Sales MSA_Unemp)

esttab est1 est1b est1c est1d using r28_tab1.tex, se scalars(N r2 bic) mtitles keep(Kphy Korg Kknow Emp Assets Sales MSA_Unemp c.MSA_Unemp#c.Korg)
esttab est1 est1a est1e est1f using r28_tab2.tex, se scalars(N r2 bic) mtitles keep(Kphy Korg Kknow Emp Assets Sales MSA_Unemp)
