...
if (reload){
  load("/Users/pedrovallocci/Documents/PhD (local)/Research/By Topic/Bargaining Power/data/comp_funda2.Rdata")
  ...
  peterstaylor <- read_csv("/Users/pedrovallocci/Documents/PhD (local)/Research/By Topic/Bargaining Power/data/peterstaylor.csv")
}

link_gvkey <- read_csv("/Users/pedrovallocci/Documents/PhD (local)/Research/By Topic/Bargaining Power/data/link_permno_gvkey.csv")
...
write.csv(compclean, '/Users/pedrovallocci/Documents/PhD (local)/Research/By Topic/Bargaining Power/data/compclean.csv')
